...
import chattingJava.UDP_1o1_chat.WinListener;

public class UDP_1o1_chat_client extends Frame implements ActionListener{
	private TextField enter;
	  private TextArea display;
	  private DatagramPacket sendPacket, receivePacket;
	  private DatagramSocket socket;
	  public UDP_1o1_chat_client(){
	     super( "server" );
	  ...
	  {
	     UDP_1o1_chat_client c = new UDP_1o1_chat_client();
	     c.waitForPackets();
	  }
